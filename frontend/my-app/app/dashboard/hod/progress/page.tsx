                                                                                                                                       ...
                                                                                                                                       <div key={record.id} className="relative pl-32 animate-in slide-in-from-left-4" style={{ animationDelay: `${index * 100}ms` }}>
                                                                                                                                                      ...
                                                                                                                                                      <div className="bg-white border border-slate-200/60 rounded-[2.5rem] p-8 shadow-sm hover:shadow-lg transition-all flex items-center justify-between group">
                                                                                                                                                                     ...
                                                                                                                                                                     <div className="flex items-center gap-3">
                                                                                                                                                                                    <button 
                                                                                                                                                                                       onClick={() => router.push(`/dashboard/hod/progress/${data.profile.prn}/record`)}
                                                                                                                                                                                       className="bg-indigo-50 text-indigo-600 px-6 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest border border-indigo-100 opacity-0 group-hover:opacity-100 transition-all translate-x-4 group-hover:translate-x-0"
                                                                                                                                                                                    >
                                                                                                                                                                                                   View Record
                                                                                                                                                                                    </button>
